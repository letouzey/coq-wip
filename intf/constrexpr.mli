...
(** representation of number literals as string of digits in base 10
    (big-endian), and a separate sign flag. Note that this representation
    is not unique, due to possible multiple leading zeros, and -0 = +0 *)
